...
agent in agents/plan-agent/, the PA's consistency checker, and anything else later
...
# kanban/index.html until 5 Sep 2026, when agents/plan-agent/pick.py needed the same
