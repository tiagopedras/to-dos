...
if (!process.env.BOARD_PORT) console.error('Note: this runs against the live board on 8765. For a throwaway copy: scripts/test-board.sh test_backups.mjs')
const checks = []
...
const chrome = spawn('/Applications/Google Chrome.app/Contents/MacOS/Google Chrome', [
  ...
  `--user-data-dir=${process.env.CHROME_PROFILE || '/tmp/todo-backups-test-profile'}`, '--window-size=1400,1000',
