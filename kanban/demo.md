...
- [ ] **Run Alex Rivera's probation review** [impact:: high] [effort:: L] [due:: 2026-09-11] [to:: Plan agent] `headline:2026-08-17`
  - Six month mark. The pack has to be with HR a week before the conversation.
  - [x] Book the review conversation [due:: 2026-08-14] `done:2026-08-13`
  - [ ] Ask Alex for their list of achievements [due:: 2026-08-26] `week`
  ...
  - [ ] Collect the 360 responses into one pack [due:: 2026-09-02] [to:: Implement agent] `rank:1` `blocked-by:alex-360`
  ...
  - [ ] Write the review and send it to HR [due:: 2026-09-04] [to:: Plan agent]
...
- [ ] **Prepare for the 1:1 with Jordan** [impact:: med] [effort:: S] [due:: 2026-08-26] [to:: Plan agent] `repeat:wed-9:15`
...
- [ ] **Chase the 360 responses** [impact:: med] [effort:: S] [due:: 2026-08-25] `#alex-360`
...
- [ ] **Set up monthly growth conversations with the team** [impact:: high] [effort:: M] `start:2026-08-20`
  ...
  - [ ] Draft the shape of the conversation [to:: Plan agent] `week`
  - [ ] Put the recurring slots in `start:2026-09-01`

- [ ] **Decide whether to open the mid-weight design role** [impact:: high] [effort:: S] [due:: 2026-09-15]
  - Budget is confirmed, the question is whether the team needs breadth or depth.

- [ ] **Tidy up the shared 1:1 notes template** [impact:: low] [effort:: S]
...
- [ ] **Unblock the checkout redesign** [impact:: high] [effort:: M] [due:: 2026-08-21] `#checkout` `urgent`
  ...
  - [ ] Sit with Jordan and pick a direction [due:: 2026-08-21]
  - [ ] Share the decision with the Web team [to:: Plan agent] `blocked-by:checkout`
...
- [ ] **Update the design QA checklist for the new checkout flow** [due:: 2026-09-08] `blocked-by:checkout`
...
- [ ] **Close the Figma against code gap on buttons** [impact:: high] [effort:: M] [due:: 2026-09-04] [to:: Plan agent] `start:2026-08-25`
...
- [ ] **Document the form components** [impact:: med] [effort:: L] [to:: Implement agent] `rank:4`
...
- [ ] **Draft the design team plan for next quarter** [impact:: high] [effort:: L] [due:: 2026-09-30] [to:: Plan agent]
...
- [ ] **Rethink how the team shares work in progress** [impact:: low] [effort:: S]
