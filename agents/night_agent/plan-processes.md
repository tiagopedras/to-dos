...
`agents/night_agent/PLAN-BRIEF.md` first — it holds the format, the three hard rules and the
tone.
...
into `dist/`. `agents/night_agent/` is the agent you are part of. `data/` is everything
private.
