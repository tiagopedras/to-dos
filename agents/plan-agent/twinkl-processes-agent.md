...
companion is read-only, and why the planning agent writes plans to their own
...
planning agent and `check_todo.py` all read the list through it, and the working
